...
##### [Chemical Reactions/Stoichiometry](scioly-sub-page-current-season-topics.html) + [Kinetics](scioly-sub-page-current-season-topics.html)

Scroll down to see details

#### Chemical Reactions/Stoichiometry

[1. Overview](scioly-sub-page-current-season-topics.html)

[2. Important Definitions](scioly-sub-page-current-season-topics.html)

[3. Equations](scioly-sub-page-current-season-topics.html)

[4. Polyatomic Ions](scioly-sub-page-current-season-topics.html)

[5. Types of Reactions](scioly-sub-page-current-season-topics.html)

[6. Balancing Chemical Equations](scioly-sub-page-current-season-topics.html)
...
1. Avogadro's Number; A numeric value that measures the number of particles (atoms, molecules, etc.) that are in 1 mole of an element.

2. Moles; A stoichiometric unit of measurement that represents a specific quantity of of a substance using the Avogadro's number.

3. Mole Ratios; The ratios of moles of each substance in a balanced chemical equation that is used for stoichiometric conversions.

4. Limiting Reactant; The reactant in a reaction that goes to completion before the other reactant(s), indicating the maximum amount of substances that can react and form.

5. Excess Reactant; The reactant(s) that is/are larger in quantity than the limiting reactant, so some will be left over once the reaction has gone to completion.

6. Theoretical Yield; The maximum theoretical amount of products that the reaction can produce.

7. Percent Yield; The ratio of the theoretical yield to the actual yield represented as a percentage. ​​​

8. Percent Error; How far the measured value is compared to the theoretical value shown as a percentage.

9. Molarity; A quantitative representation of how concentrated a solution is.

1. The Stoichiometry Conversion Chain:
...
1. Given that the percent composition of the compound is 40% C, 6.71% H, and 53.29% O

2. Always assume the % composition is taken from an 100g. sample, so 40% C becomes 40g. C

3. Convert the masses into moles separately;
...
4. Find the element with the smallest number of moles, in this case it's either C or O (3.33 moles)

5. Divide the moles of each element by the smallest number of moles

- 3.33 moles of C/3.33 moles = 1 mole of C

- 6.66 moles of H/3.33 moles = 2 moles of H

- 3.33 moles of O/3.33 moles = 1 mole of O

6. Use the simplified mole ratios as subscripts in the final chemical formula!

Formula for the above example:

Using the same example, let's find the Molecular Formula for the same compound:

1. Given the Empirical Formula is

2. Given that the experimentally measured molar mass is 60.052g.

3. Obtain the empirical mass by adding the mass of all elements in the Empirical Formula

C + H + H + O = 12.01g. + 1.008g. + 1.008g. + 15.999g. = 30.026g.

4. Divide the molar mass by the empirical mass to find "n"

- 60.052g./30.028g. = 2

- n = 2

5. Multiply the subscripts of elements in the Empirical Formula by "n"

2 ( ) =

6. Congratulations! You now have successfully found the Molecular Formula!
...
1. Given that there are 4.0 moles of Hydrogen gas and 3.0 moles of Oxygen gas

2. Convert moles of each reactant into moles of products separately using mole ratios:

- 4.0 moles x = 4.0 moles

- 3.0 moles x = 6.0 moles

3. Compare the two results, find the least number of moles, and the corresponding reactant will be the Limiting Reactant:
...
[4. Factors Affecting Reaction Rates](scioly-sub-page-current-season-topics.html)

[5. Collision Theory and Reaction Progression Graphs](scioly-sub-page-current-season-topics.html)

[6. Determining Reaction Rates](scioly-sub-page-current-season-topics.html)

[7. Rate Laws](scioly-sub-page-current-season-topics.html)

[8. Integrated Rate Laws](scioly-sub-page-current-season-topics.html)

[9. Half Life](scioly-sub-page-current-season-topics.html)

Kinetics is the study of how fast a reaction proceeds to completion, and the factors that affect the rate of reactions.

1. Activation Energy; The minimum amount of energy required for a reaction to proceed in either the forward or reverse direction.

2. Catalysts; A substance that speeds up the reaction by lowering the activation energy without being consumed in the reaction itself.

3. Effective Collision; The collision between molecules that has enough potential to lead to a chemical reaction.

4. Rate of Reactions; The measure of the speed in which reactants are converted into products in a chemical reaction.

5. Rate Constant (k); A number that relates the rate of a chemical reaction to the concentration of the reaction. Indicates how fast a reaction will proceed under different circumstances, such as pressure or temperature. Larger "k" values indicate faster reactions while smaller "k" values indicate slower reactions. The most common units of "k" is listed below:

6. Reaction Order; The reaction order shows how the rate of a reaction is affected by the concentration of each reactant. It is found by looking at the exponents in the rate law, and it tells you how changing a reactant’s concentration changes the reaction rate.​​​

7. Overall Reaction Order; The sum of all the individual reaction orders (defined above).

8. Sufficient Energy; The minimum energy required for a reaction to occur.
...
10. Reaction Mechanisms; A series of elementary steps/elementary reactions (a set of steps a reaction goes on) that together represents the overall progress of a chemical reaction.

11. Reaction Intermediates; Species that appear in a reaction mechanism but not the overall balanced reaction. It is formed in one elementary step and consumed in a later step.

1. The Rate Law (general formula):

rate = , where "x" is the reaction order with respect to element A, and "y" is the reaction order with respect to element B.

2. Units of the rate constant (k):
...
1. Temperature; As temperature increases, the reaction usually speeds up due to the increase in kinetic energy, thus, molecules collide with each other more energetically and more frequently, increasing the number of effective collisions.

2. Concentration; As the concentration increases, reaction rate becomes higher due to more molecules being present which are able to produce more frequent effective collisions.

3. Catalyst; A catalyst lowers the activation energy of a reaction, so the reaction rate increases in speed because it's able to proceed with less required circumstances.

4. Surface Area; As surface area increase, there are more opportunities for effective collisions to occur because there are more area that molecules can collide with.

5. Pressure of gaseous substances; When pressure increases, reaction rate also increases because the molecules are closer together, thus, they will collide into each other more frequently, leading to a higher rate of effective collisions.
...
1. Rate laws are ALWAYS determined from experiments.

2. Reaction orders are NEVER defined using the concentration of the products. It's always with respects to the concentrations of the reactants.

3. The reaction orders are NOT the same as, and therefore, NOT related to the coefficients in a balanced chemical equation unlike equations used in Equilibrium. It is always obtained through experimental data.
...
1. Find two trials where one element's concentration changes while the other remains constant.

In this case we will first look at trials 1 and 2.

2. Plug in the numbers into the Rate Law general formula:
...
3. Solve the equation like a system of equations problem, and use division to cancel out the terms (tip: put the trial with larger numbers on top for simplicity):

2 =

4. Solve the simplified equation using exponential properties. In this example, x = 1. This means that the reaction order is 1 with respect to element A.

5. Repeat the process to find the reaction order for element B. We will compare trials 2 and 3 this time (tip: you should be plugging in the known reaction order that you just found, in this case it's first order with respect to element A, to make the equation simpler):
